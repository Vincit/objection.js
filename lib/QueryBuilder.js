...
QueryBuilder.prototype.isFindQuery = function () {
  return !this._customMethodCall && !_.any(this._knexMethodCalls, function (call) {
...
QueryBuilder.prototype.clone = function () {
  ...
  clone._customMethodCall = this._customMethodCall;
...
QueryBuilder.prototype.clear = function () {
  if (arguments.length) {
    ...
    if (this._customMethodCall && _.contains(args, this._customMethodCall.method)) {
      this._customMethodCall = null
    }
  } else {
    this._customMethodCall = null;
...
QueryBuilder.prototype.has = function (methodName) {
  return !!_.find(this._knexMethodCalls, {method: methodName})
    || (this._customMethodCall && this._customMethodCall.method === methodName);
};
 ...
 * @returns {QueryBuilder}
 */
QueryBuilder.prototype.insert = customQueryMethod('insert', 'knexInsert');
 ...
 * @returns {QueryBuilder}
 */
QueryBuilder.prototype.knexInsert = knexQueryMethod('insert');
 ...
 * @returns {QueryBuilder}
 */
QueryBuilder.prototype.update = customQueryMethod('update', 'knexUpdate');
 ...
 * @returns {QueryBuilder}
 */
QueryBuilder.prototype.knexUpdate = knexQueryMethod('update');
 ...
 * @returns {QueryBuilder}
 */
QueryBuilder.prototype.patch = customQueryMethod('patch');
 ...
 * @returns {QueryBuilder}
 */
QueryBuilder.prototype.delete = customQueryMethod('delete', 'knexDelete');
 ...
 * @returns {QueryBuilder}
 */
QueryBuilder.prototype.knexDelete = knexQueryMethod('delete');
 ...
 * @returns {QueryBuilder}
 */
QueryBuilder.prototype.del = customQueryMethod('delete', 'knexDelete');
 ...
 * @returns {QueryBuilder}
 */
QueryBuilder.prototype.relate = customQueryMethod('relate');
 ...
 * @returns {QueryBuilder}
 */
QueryBuilder.prototype.unrelate = customQueryMethod('unrelate');
 ...
 * @returns {QueryBuilder}
 */
QueryBuilder.prototype.increment = knexQueryMethod('increment');
 ...
 * @returns {QueryBuilder}
 */
QueryBuilder.prototype.decrement = knexQueryMethod('decrement');
 ...
 * @returns {Function}
 */
function customQueryMethod(methodName, fallbackMethod) {
  /**
   * @returns {QueryBuilder}
   */
  return function () {
    if (this._customImpl[methodName]) {
      this._customMethodCall = {
        method: methodName,
        args: _.toArray(arguments)
      };
    } else if (fallbackMethod) {
      this[fallbackMethod].apply(this, arguments);
    }
...
function build(builder) {
  ...
  var customCall = builder._customMethodCall;

  if (customCall && builder._customImpl[customCall.method]) {
    builder._customImpl[customCall.method].apply(builder, customCall.args);
  }

  if (builder.isFindQuery() && builder._customImpl.find) {
