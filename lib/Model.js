...
Model.prototype.$query = function () {
  ...
  return ModelClass.QueryBuilder
    ...
    .insertImpl(function () {
      var queryBuilder = this;
      ModelClass.$$insert(queryBuilder, self);
    })
    .updateImpl(function (update) {
      var queryBuilder = this;
      ModelClass.$$update(queryBuilder, update || self).where(ModelClass.getFullIdColumn(), self.$id());
    })
    .patchImpl(function (patch) {
      var queryBuilder = this;
      ModelClass.$$patch(queryBuilder, patch || self).where(ModelClass.getFullIdColumn(), self.$id());
    })
    .deleteImpl(function () {
      var queryBuilder = this;
      ModelClass.$$delete(queryBuilder).where(ModelClass.getFullIdColumn(), self.$id());
    })
    .relateImpl(function () {
...
Model.prototype.$relatedQuery = function (relationName) {
  ...
  return ModelClass.RelatedQueryBuilder
    ...
    .insertImpl(function (modelsToInsert) {
      var queryBuilder = this;
      relation.insert(queryBuilder, self, modelsToInsert);
    })
    .updateImpl(function (update) {
      var queryBuilder = this;
...
Model.query = function () {
  ...
  return ModelClass.QueryBuilder
    ...
    .insertImpl(function (models) {
      var queryBuilder = this;
      ModelClass.$$insert(queryBuilder, models);
    })
    .updateImpl(function (update) {
      var queryBuilder = this;
      ModelClass.$$update(queryBuilder, update);
    })
    .patchImpl(function (patch) {
      var queryBuilder = this;
      ModelClass.$$patch(queryBuilder, patch);
    })
    .deleteImpl(function () {
      var queryBuilder = this;
      ModelClass.$$delete(queryBuilder);
    })
    .relateImpl(function () {
      throw new Error('`relate` makes no sense in this context');
    })
...
Model.$$insert = function (builder, $models) {
  ...
  return builder.knexInsert(json).runAfterModelCreatePushFront(function (ret) {
...
Model.$$updateWithOptions = function (builder, $update, options) {
  ...
  return builder.knexUpdate(update.$toDatabaseJson()).runAfterModelCreatePushFront(function () {
...
Model.$$delete = function (builder) {
  return builder.knexDelete().runAfterModelCreatePushFront(function () {
    return {};
  });
};
