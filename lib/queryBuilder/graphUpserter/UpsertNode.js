...
class UpsertNode {
  ...
  constructor(parentNode, relExpr, upsertModel, currentModel, queryProps, opt) {
    ...
    if (this.upsertModel !== null && this.currentModel === null && this.upsertModel.$hasId() && this.type === UpsertNodeType.None) {
      throw new Error([
...
function getType(node) {
  ...
  } else if (!hasChanges(node.currentModel, node.upsertModel, node.queryProps)) {
    return UpsertNodeType.None;
  } else {
