...
class DelegateOperation extends QueryBuilderOperation {
  ...
  hasOnBefore1() {
    return (
      this.onBefore1 !== DelegateOperation.prototype.onBefore1 ||
      this.delegate.hasOnBefore1()
    );
  }
  ...
  hasOnBefore2() {
    return (
      this.onBefore2 !== DelegateOperation.prototype.onBefore2 ||
      this.delegate.hasOnBefore2()
    );
  }
  ...
  hasOnBefore3() {
    return (
      this.onBefore3 !== DelegateOperation.prototype.onBefore3 ||
      this.delegate.hasOnBefore3()
    );
  }
  ...
  hasOnBuild() {
    return (
      this.onBuild !== DelegateOperation.prototype.onBuild ||
      this.delegate.hasOnBuild()
    );
  }
  ...
  hasOnBuildKnex() {
    return (
      this.onBuildKnex !== DelegateOperation.prototype.onBuildKnex ||
      this.delegate.hasOnBuildKnex()
    );
  }
  ...
  hasOnRawResult() {
    return (
      this.onRawResult !== DelegateOperation.prototype.onRawResult ||
      this.delegate.hasOnRawResult()
    );
  }
  ...
  hasOnAfter1() {
    return (
      this.onAfter1 !== DelegateOperation.prototype.onAfter1 ||
      this.delegate.hasOnAfter1()
    );
  }
  ...
  hasOnAfter2() {
    return (
      this.onAfter2 !== DelegateOperation.prototype.onAfter2 ||
      this.delegate.hasOnAfter2()
    );
  }
  ...
  hasOnAfter3() {
    return (
      this.onAfter3 !== DelegateOperation.prototype.onAfter3 ||
      this.delegate.hasOnAfter3()
    );
  }
