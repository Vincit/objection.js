...
class QueryBuilder extends QueryBuilderBase {
  ...
  updateAndFetch(modelOrObject) {
    return this.writeOperation(() => {
      ...
      this.addOperation(updateAndFetch, [delegateOperation.instance.$id(), modelOrObject]);
    });
  }
  ...
  patchAndFetch(modelOrObject) {
    return this.writeOperation(() => {
      ...
      this.addOperation(patchAndFetch, [delegateOperation.instance.$id(), modelOrObject]);
    });
  }
