...
class QueryBuilder extends QueryBuilderBase {
  ...
  table(table) {
    ...
    this._context.tableMap = this._context.tableMap || {};
    this._context.tableMap[this._modelClass.tableName] = table;

    return this;
  }

  alias(alias) {
    this._context.aliasMap = this._context.aliasMap || {};
    this._context.aliasMap[this._modelClass.tableName] = alias;
    return this;
  }

  tableRefFor(modelClass) {
    const tableName = this.tableNameFor(modelClass);
    const aliasMap = this._context.aliasMap;
    return (aliasMap && aliasMap[modelClass.tableName]) || tableName;
  }

  tableNameFor(modelClass) {
    const tableMap = this._context.tableMap;
