...
class QueryBuilderBase extends QueryBuilderOperationSupport {
  ...
  whereJsonEquals() {
    return this.addOperation(
      new WhereJsonPostgresOperation('whereJsonEquals', {
        operator: '=',
        bool: 'and'
      }),
      arguments
  ...
  orWhereJsonEquals() {
    return this.addOperation(
      new WhereJsonPostgresOperation('orWhereJsonEquals', {
        operator: '=',
        bool: 'or'
      }),
      arguments
  ...
  whereJsonNotEquals() {
    return this.addOperation(
      new WhereJsonPostgresOperation('whereJsonNotEquals', {
        operator: '!=',
        bool: 'and'
      }),
      arguments
  ...
  orWhereJsonNotEquals() {
    return this.addOperation(
      new WhereJsonPostgresOperation('orWhereJsonNotEquals', {
        operator: '!=',
        bool: 'or'
      }),
      arguments
