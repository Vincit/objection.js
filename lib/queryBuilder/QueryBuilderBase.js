...
class QueryBuilderBase extends QueryBuilderOperationSupport {
  ...
  isSelectAll() {
    return !this.has(SelectSelector) && !this.has(WhereSelector);
  }
  ...
  orHavingNotIn() {
    return this.addOperation(
      new KnexOperation('orHavingNotIn'),
      arguments
    );
  }
  ...
  orHavingNull() {
    return this.addOperation(
      new KnexOperation('orHavingNull'),
      arguments
    );
  }
  ...
  havingNotNull() {
    return this.addOperation(
      new KnexOperation('havingNotNull'),
      arguments
    );
  }
  ...
  orHavingNotNull() {
    return this.addOperation(
      new KnexOperation('orHavingNotNull'),
      arguments
    );
  }
  ...
  havingExists() {
    return this.addOperation(
      new KnexOperation('havingExists'),
      arguments
    );
  }
  ...
  orHavingExists() {
    return this.addOperation(
      new KnexOperation('orHavingExists'),
      arguments
    );
  }
  ...
  havingNotExists() {
    return this.addOperation(
      new KnexOperation('havingNotExists'),
      arguments
    );
  }
  ...
  orHavingNotExists() {
    return this.addOperation(
      new KnexOperation('orHavingNotExists'),
      arguments
    );
  }
  ...
  havingBetween() {
    return this.addOperation(
      new KnexOperation('havingBetween'),
      arguments
    );
  }
  ...
  havingNotBetween() {
    return this.addOperation(
      new KnexOperation('havingNotBetween'),
      arguments
    );
  }
  ...
  whereRef() {
    console.warn('whereRef is deprecated. Use where("foo", ref("bar")) instead. whereRef will be removed in version 1.0');
  ...
  orWhereRef() {
    console.warn('orWhereRef is deprecated. Use orWhere("foo", ref("bar")) instead. orWhereRef will be removed in version 1.0');
