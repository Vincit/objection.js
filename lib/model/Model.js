...
class Model {
  ...
  $toJson(shallow) {
    if (shallow) {
      return toJson(this, false, this.constructor.getRelations(), null);
    } else {
  ...
  $toDatabaseJson() {
    ...
    if (jsonSchema && this.constructor.pickJsonSchemaProperties) {
      ...
      return toJson(this, true, this.constructor.getRelations(), null);
    }
  }
  ...
  $omitFromJson(keys) {
    if (arguments.length === 0) {
      ...
      if (!this.hasOwnProperty('$$omitFromJson')) {
        Object.defineProperty(this, '$$omitFromJson', {
          enumerable: false,
          writable: true,
          configurable: true,
          value: keys
  ...
  $omitFromDatabaseJson(keys) {
    if (arguments.length === 0) {
      ...
      if (!this.hasOwnProperty('$$omitFromDatabaseJson')) {
        Object.defineProperty(this, '$$omitFromDatabaseJson', {
          enumerable: false,
          writable: true,
          configurable: true,
          value: keys
  ...
  static getValidator() {
    ...
    // will fail for subclasses and the value gets re-evaluated.
    if (!this.hasOwnProperty('$$validator')) {
      Object.defineProperty(this, '$$validator', {
        writable: true,
        configurable: true,
        enumerable: false,
        value: this.createValidator()
      });
    }
  ...
  static columnNameToPropertyName(columnName) {
    ...
    if (!this.hasOwnProperty('$$colToProp')) {
      Object.defineProperty(this, '$$colToProp', {
        writable: true,
        configurable: true,
        enumerable: false,
  ...
  static propertyNameToColumnName(propertyName) {
    ...
    if (!this.hasOwnProperty('$$propToCol')) {
      Object.defineProperty(this, '$$propToCol', {
        writable: true,
        configurable: true,
        enumerable: false,
        value: Object.create(null)
    ...
    if (!this.hasOwnProperty('$$idColumnArray')) {
      Object.defineProperty(this, '$$idColumnArray', {
        writable: true,
        configurable: true,
        enumerable: false,
        value: getIdColumnArray(this)
      });
    }
  ...
  static getFullIdColumn() {
    ...
    if (!this.hasOwnProperty('$$fullIdColumn')) {
      Object.defineProperty(this, '$$fullIdColumn', {
        writable: true,
        configurable: true,
        enumerable: false,
        value: getFullIdColumn(this)
      });
    }
  ...
  static getIdPropertyArray() {
    ...
    if (!this.hasOwnProperty('$$idPropertyArray')) {
      Object.defineProperty(this, '$$idPropertyArray', {
        writable: true,
        configurable: true,
        enumerable: false,
        value: getIdPropertyArray(this)
      });
    }
  ...
  static getRelationArray() {
    ...
    if (!this.hasOwnProperty('$$relationArray')) {
      ...
      Object.defineProperty(this, '$$relationArray', {
        enumerable: false,
        writable: true,
        configurable: true,
        value: Object.keys(relations).map(key => relations[key])
      });
    }
  ...
  static bindKnex(knex) {
    ...
    for (let i = 0, l = staticHiddenProps.length; i < l; ++i) {
      ...
      if (ModelClass.hasOwnProperty(prop)) {
        Object.defineProperty(BoundModelClass, prop, {
          writable: true,
          configurable: true,
          enumerable: false,
          value: ModelClass[prop]
        });
      }
    }
    ...
    Object.defineProperties(BoundModelClass, {
      $$relations: {
        enumerable: false,
        writable: true,
        configurable: true,
        value: boundRelations
      },
      $$relationArray: {
        enumerable: false,
        writable: true,
        configurable: true,
        value: boundRelationArray
      }
    });
