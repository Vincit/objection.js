...
describe('Performance tests', function() {
  ...
  describe('Model methods (85 models in the dataset)', function() {
    ...
    perfTest({
      name: `16000 fromJson calls for the dataset (${16000 *
    ...
    perfTest({
      name: `60000 $toJson calls for the dataset (${60000 *
        85} individual models)`,
      runCount: 60000,
      runtimeGoal: 10000,
      beforeTest: function() {
    ...
    perfTest({
      name: `120000 $toDatabaseJson calls for the dataset (${120000 *
    ...
    perfTest({
      name: `100000 $clone calls for the dataset (${100000 *
        85} individual models)`,
      runCount: 100000,
      runtimeGoal: 10000,
      beforeTest: function() {
      ...
      beforeTest: function() {
        ...
        var results = [
          ...
          _.flatten(
            _.range(numPeople).map(function(parentId) {
              return _.flatten(
                _.range(numChildren).map(function(childIdx) {
                  var childId = parentId * numChildren + childIdx;
