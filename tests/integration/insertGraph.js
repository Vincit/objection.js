...
module.exports = session => {
  ...
  describe('Model insertGraph queries', () => {
    ...
    let insertion;
    let eagerExpr =
      '[model1Relation1.model1Relation3, model1Relation1Inverse, model1Relation2.model2Relation2]';
    ...
    describe('.query().insertGraph()', () => {
      ...
      it('should accept raw sql and subqueries', () => {
        return Model1.query()
          ...
          .then(inserted => {
            inserted.model1Relation2 = _.sortBy(
              inserted.model1Relation2,
              'idCol'
            );
          ...
          .then(inserted => {
            inserted[0].model1Relation2 = _.sortBy(
              inserted[0].model1Relation2,
              'idCol'
            );
    ...
    function check(model, shouldCheckHooks) {
      ...
      expect(model.model1Relation1.model1Relation3[0].model2Prop1).to.equal(
        'child1'
      );
      shouldCheckHooks && checkHooks(model.model1Relation1.model1Relation3[0]);

      expect(model.model1Relation1.model1Relation3[1].model2Prop1).to.equal(
        'cibling2'
      );
      expect(model.model1Relation1.model1Relation3[1].extra1).to.equal(
        'extraVal1'
      );
      expect(model.model1Relation1.model1Relation3[1].extra2).to.equal(
        'extraVal2'
      );
      ...
      expect(model.model1Relation2[1].model2Relation2.model1Prop1).to.equal(
        'child3'
      );
