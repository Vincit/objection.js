    ...
    describe('knex methods', function () {
      ...
      it('.join()', function () {
        return Model2
          ...
          .where('model2Prop2', '>', 15)
          .join('Model1', 'Model2.model1Id', 'Model1.id')
          .then(function (models) {
            expect(models[0]).to.be.a(Model2);
      ...
      describe('knex methods', function () {
        ...
        it('.orWhere()', function () {
          return parent2
            .$relatedQuery('model1Relation2')
            .where(function () {
              this.where('model2Prop2', '=', '1').orWhere('model2Prop2', '=', '3');
            })
            .orderBy('model2Prop2')
            .then(function (related) {
        ...
        it('.join()', function () {
          return parent2
            ...
            .join('Model1 as Parent', 'Model2.model1Id', 'Parent.id')
            .orderBy('Model2.id', 'desc')
            .then(function (related) {
      ...
      describe('knex methods', function () {
        ...
        it('.join()', function () {
          return Promise.all([
            parent1
              .$relatedQuery('model2Relation1')
              .select('Model1.*', 'Model2.model2Prop1 as parentProp1')
              .join('Model2', 'Model1Model2.model2Id', 'Model2.id')
