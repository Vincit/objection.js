        ...
        if (session.isPostgres()) {
          ...
          it('smoke test for various methods', () => {
            ...
            return Model2.query()
              ...
              .whereColumn('model2.id_col', 'model2.prop1')
              .andWhereColumn('model2.id_col', 'model2.prop2')
              .orWhereColumn('model2.id_col', 'model2.prop3')
              .whereNotColumn('model2.id_col', 'model2.prop1')
              .andWhereNotColumn('model2.id_col', 'model2.prop2')
              .orWhereNotColumn('model2.id_col', 'model2.prop3')
