          ...
          return A.query()
            ...
            .then(a1 => {
              return [
                ...
                a1
                  .$relatedQuery('b')
                  .insert({id3: 1000, id4: '2000', bval: 'new'})
              ];
            })
            .spread((a1, bNew) => {
          ...
          return A.query()
            ...
            .then(a1 => {
              return [
                ...
                a1
                  .$relatedQuery('b')
                  .updateAndFetchById([1, '1'], {bval: 'updated'})
              ];
            })
            .spread((a1, b1) => {
          ...
          return B.query()
            ...
            .then(b1 => {
              return [
                ...
                b1
                  .$relatedQuery('a')
                  .insert({id1: 1000, id2: '2000', aval: 'new'})
              ];
            })
            .spread((b1, aNew) => {
        ...
        it('insert', () => {
          ...
          return B.query()
            ...
            .spread((a, ab) => {
              ...
              expect(ab).to.eql(
                abOld.concat([{aid1: 1000, aid2: '2000', bid3: 1, bid4: '2'}])
              );
            });
        });
        ...
        it('relate', () => {
          ...
          return B.query()
            ...
            .spread((a, ab) => {
              ...
              expect(ab).to.eql(
                _.sortBy(
                  abOld.concat([{aid1: 1, aid2: '2', bid3: 1, bid4: '2'}]),
                  ['bid3', 'bid4', 'aid1', 'aid2']
                )
              );
            });
