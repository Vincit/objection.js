        ...
        it('should relate', () => {
          return Model2.query()
            ...
            .then(rows => {
              ...
              expect(_.filter(rows, {model2Id: 1, model1Id: 3})).to.have.length(
                1
              );
              expect(_.filter(rows, {model2Id: 1, model1Id: 5})).to.have.length(
                1
              );
              expect(_.filter(rows, {model2Id: 2, model1Id: 4})).to.have.length(
                1
              );
              expect(_.filter(rows, {model2Id: 2, model1Id: 5})).to.have.length(
                1
              );
              expect(_.filter(rows, {model2Id: 2, model1Id: 6})).to.have.length(
                1
              );
            });
        });
          ...
          it('should relate (multiple values)', () => {
            return Model2.query()
              ...
              .then(rows => {
                ...
                expect(
                  _.filter(rows, {model2Id: 1, model1Id: 3})
                ).to.have.length(1);
                expect(
                  _.filter(rows, {model2Id: 1, model1Id: 5})
                ).to.have.length(1);
                expect(
                  _.filter(rows, {model2Id: 1, model1Id: 6})
                ).to.have.length(1);
                expect(
                  _.filter(rows, {model2Id: 2, model1Id: 4})
                ).to.have.length(1);
                expect(
                  _.filter(rows, {model2Id: 2, model1Id: 5})
                ).to.have.length(1);
                expect(
                  _.filter(rows, {model2Id: 2, model1Id: 6})
                ).to.have.length(1);
              });
          });
        }
        ...
        it('should relate with extra properties', () => {
          return Model2.query()
            ...
            .then(rows => {
              ...
              expect(
                _.filter(rows, {model2Id: 1, model1Id: 5, extra3: 'foobar'})
              ).to.have.length(1);
              expect(_.filter(rows, {model2Id: 2, model1Id: 4})).to.have.length(
                1
              );
        ...
        it('should relate', () => {
          return Model2.query()
            ...
            .then(rows => {
              ...
              expect(_.filter(rows, {model2Id: 1, model1Id: 2})).to.have.length(
                1
              );
            });
        });
