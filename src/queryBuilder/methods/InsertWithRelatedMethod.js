...
export default class InsertWithRelatedMethod extends DelegateMethod {

  constructor(builder, name, opt) {
    super(builder, name, opt);

    // Our delegate method inherits from `InsertRelation`. Disable the call-time
    // validation. We do the validation in onAfterModelCreateFront instead.
  ...
  // This is a bit hacky.
  onAfterModelCreateFront(builder) {
    ...
    return inserter.execute(tableInsertion => {
      ...
      return super.onAfterModelCreateFront(builder, this.models)
    });
  }
